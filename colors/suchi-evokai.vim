...
hi Conditional           guifg=#ff7a14   guibg=NONE      gui=NONE
hi Repeat                guifg=#ff7a14   guibg=NONE      gui=NONE
...
hi Exception             guifg=#ff7a14   guibg=NONE      gui=NONE
...
hi Error                 guifg=#d7d7d7   guibg=#ff7a14   gui=NONE
...
hi ErrorMsg              guifg=#ff7a14   guibg=NONE      gui=NONE
...
hi cssMedia              guifg=#ff7a14   guibg=NONE      gui=NONE
...
hi gitcommitOverflow     guifg=#ff7a14   guibg=#2e0000   gui=bold
...
hi GitGutterDelete       guifg=#ff7a14   guibg=#1b1b13   gui=NONE
hi GitGutterChangeDelete guifg=#fff600   guibg=#1b1b13   gui=NONE

" ALE Signs
hi ALEErrorSign          guifg=#ff7a14   guibg=#1b1b13   gui=BOLD
...
hi SignifySignDelete     guifg=#ff7a14   guibg=#1b1b13   gui=NONE

" Syntastic Plugin
hi SyntasticErrorSign    guifg=#ff7a14   guibg=#1b1b13   gui=bold
...
" Easy Motion
hi EasyMotionTarget      guifg=#ff7a14   guibg=#1b1b13   gui=BOLD
