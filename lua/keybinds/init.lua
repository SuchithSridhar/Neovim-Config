vim.keymap.set(
  ...
  "jk",
  "<Esc>",
  { desc = "jk keymap for faster insert mode exit" }
)
vim.keymap.set(
  "n",
  "<leader>nh",
  "<cmd>nohlsearch<CR>",
  { desc = "[N]o [H]ighlight search results" }
)
...
vim.keymap.set(
  ...
  { desc = "Go to [D]iagnostics [N]ext message" }
)
vim.keymap.set(
  "n",
  "<leader>dp",
  vim.diagnostic.goto_prev,
  { desc = "Go to [D]iagnostics [P]revious message" }
)
vim.keymap.set(
  "n",
  "<leader>df",
